...
$sql = mysqli_query($link,"SELECT i_n_d_vig, i_n_d_vig_m, i_m_d_vig, in_nor, iva_int, t_mora, abono_cap FROM informacion WHERE contrato='$credito'");
...
echo '<input type="text" name="saldo" maxlength="10" id="vspre" class="cuadrosP" value="'.$res['abono_cap'].'" onblur="actualizar_total();"/ required>';
echo "<br>";
